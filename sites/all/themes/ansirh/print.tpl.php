...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language; ?>" version="XHTML+RDFa 1.0" dir="<?php print $language->dir; ?>">
  ...
  <body class="print-body">
    <?php if ($print_logo): ?>
      <div class="print-logo" style="display: block;"><?php print $print_logo; ?></div>
    <?php endif; ?>
    <div class="print-content" style="font-size: 9pt;">
        <?php
        //print '<pre>'.print_r($node, true).'</pre>';
        if($node->type == 'faculty_staff') {
            print views_embed_view('staff_member','block_1', $node->nid);
            print views_embed_view('staff_member','block_5', $node->nid);
            print views_embed_view('research_related_content','block_2', $node->nid);
            print views_embed_view('publications','block_3', $node->nid);
            print views_embed_view('media_coverage','block_2', $node->nid);
            print views_embed_view('awards','block_2', $node->nid);
        }
        //print $content; ?></div>
    <hr class="print-hr" />
