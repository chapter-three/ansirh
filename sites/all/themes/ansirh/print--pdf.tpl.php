...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language; ?>" version="XHTML+RDFa 1.0" dir="<?php print $language->dir; ?>">
  ...
  <body class="pdf" style="font-size: 7pt;">
    <div class="print-logo" style="min-height: 48pt;">&nbsp;<br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /></div>
    <div class="print-content" style="padding: 0 48pt;">
        <?php
        //print '<pre>'.print_r($node, true).'</pre>';
        if($node->type == 'faculty_staff') {
            print '<br /><br />';
            print views_embed_view('staff_member','block_6', $node->nid);
            print views_embed_view('research_related_content','block_6', $node->nid);
            print views_embed_view('publications','block_12', $node->nid);
            print views_embed_view('media_coverage','block_6', $node->nid);
            print views_embed_view('awards','block_4', $node->nid);
        }
        //print $content; ?></div>

    <?php if ($sourceurl_enabled): ?>
      <div class="print-source_url" style="padding: 0 48pt;>
